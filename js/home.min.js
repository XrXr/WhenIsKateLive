...
a)return a;var b=[],c;for(c in this)this.hasOwnProperty(c)&&b.push(this[c]);a=b.sort(f);return b}}()});return e}(),s=function(){function b(a,b){var d=a+" "+b;return 1<a?d+"s":d}function a(a){var c=moment.duration(1E3*a);a=c.days();var d=c.hours(),e=c.minutes(),c=c.seconds(),h=[];a&&h.push(b(a,"day"));d&&h.push(b(d,"hour"));e&&h.push(b(e,"minute"));c&&h.push(b(c,"second"));return h.join(", ")}return function(b,c){var d=c.start.unix()-b;if(0<d)return a(d);if(0>d)return a(c.start.clone().add("weeks",
